        ...
        <div className="bg-darkblue -mt-40">
            <div className="mx-auto max-w-2xl pt-48 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                <div className="my-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
                    ...
                    <div className='col-span-4 md:col-span-12 lg:col-span-4'>
                        ...
                        <div className='flex gap-4'>
                            <Link href="https://www.facebook.com/pengrafic3" className='footer-fb-icons'>
                                <Image src={'/assets/footer/facebook.svg'} alt="facebook" width={15} height={20} />
                            </Link>
                            <Link href="https://github.com/djvamps" className='footer-icons'>
                                <Image src={'/assets/footer/github.svg'} alt="github" width={20} height={20} />
                            </Link>
                            <Link href="https://www.instagram.com/pengrafic_/" className='footer-icons'>
                    ...
                    <div className='col-span-4 md:col-span-4 lg:col-span-4'>
                        ...
                        <div className="flex gap-2 mt-10">
                            ...
                            <h5 className="text-base font-normal text-offwhite">+ 51 992 870 423</h5>
                        </div>
                        <div className="flex gap-2 mt-10">
                            <Image src={'/assets/footer/email.svg'} alt="email-icon" width={24} height={24} />
                            <h5 className="text-base font-normal text-offwhite">djvamps2007@gmail.com</h5>
                        </div>
                    </div>
                ...
                <div className='py-10 lg:flex items-center justify-between border-t border-t-bordertop'>
                    <h4 className='text-offwhite text-sm text-center lg:text-start font-normal'>@2025 Agency. All Rights Reserved by <Link href="https://pengrafic.com/" target="_blank"> Cabuby</Link></h4>
